                        ...
                        <TrackVisibility>
                            {({ isVisible }) =>
                                <div className={isVisible ? "animate__animated animate__fadeInDown" : ""}>
                                    ...
                                    <span className='d-flex align-items-center justify-content-md-start mt-5'>
                                        <a href='#connect' className='btn d-flex align-items-center' onClick={() => { console.log('quero estabelecer contato!') }}>
